...
<main role="main">
  ...
  <input type="hidden" name="already-attached" value="<?php echo $attachments[0]['id']; ?>">
          ...
          <input onclick="addActivity();" style="display:none !important;" type="button" value="+" id="btn-add-activity" name="btn-add-activity" class="input inline small">
              ...
              <div class="emp-job-activity-details <?php if($jobs[0]['job_activity'] == "one") { echo "one"; } else { echo "multiple"; } ?>">
                <?php 
                $i = 1; 
                ...
                <div class="multiple-selected-option">
                  ...
                  <label for="actCondition1" class="custom-checkbox">
                    <input id="jp_actvty_comp_yes" name="jp_actvty_comp" type="radio" value="yes">
                  ...
                  <label for="actCondition2" class="custom-checkbox">
                    <input id="jp_actvty_comp_no" name="jp_actvty_comp" type="radio" value="no">
