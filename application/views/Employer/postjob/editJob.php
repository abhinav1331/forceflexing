  ...
  <section class="page-wrap">
        ...
        <section class="post-job-wrapper">
          ...
          <form action="" method="post" name="post_job" id="post_job"  enctype="multipart/form-data">
            <div class="emp-job-description">
              ...
              <input name="jp_title" id="jp_title" placeholder="Please type name of job" type="text" class="input" value="<?php echo $jobs[0]['job_title']; ?>">
              <h3>Description of job</h3>
              <?php $descriptionCount = strlen($jobs[0]['job_description']); ?>
              <div class="char-left"><?php echo $finalCout = 5000 - $descriptionCount; ?> characters left</div>
              <input type="hidden" class="charcterLimit" value="<?php echo $finalCout; ?>">

              <textarea id="jp_desc" name="jp_desc" cols="" rows="" class="input resizable large" placeholder="Type message"><?php echo $jobs[0]['job_description']; ?></textarea>
            </div>
	...
	c0,10.323-8.399,18.717-18.716,18.717c-10.323,0-18.73-8.394-18.73-18.717V227.048H263.173z"/>
              ...
              <p>The file can be up to 5 mb in size.</p>
               <a href="<?php echo $attachments[0]['url'] ?>" download target="_blank;">Download</a>
            </div>
             <input type="hidden" name="already-attached" value="<?php echo $attachments[0]['id']; ?>">
			
            <div class="emp-hires">
				<h3>How many employees do you need to hire for this job?</h3>
				<label class="radio-custom">
					<input   <?php if($jobs[0]['nu_emp'] == "one") {echo "checked";} ?> type="radio" name="jp_reqemp" id="jp_reqemp_one" value="one" id="empRequired_1">
            ...
            <div class="emp-job-activity">
              ...
              <label class="radio-custom">
                <input  <?php if($jobs[0]['job_activity'] == "one") {echo "checked";} ?> type="radio" id="jp_activities_one" name="jp_activities" value="one"  checked>
                <span class="radio"></span>One
			</label>
            <label class="radio-custom">
                <input <?php if($jobs[0]['job_activity'] == "multiple") {echo "checked";} ?>  type="radio" id="jp_activities_mul" name="jp_activities" value="multiple">
                <span class="radio"></span>Multiple
			</label>
          ...
          <input onclick="addActivity();" style="display:none !important;" type="button" value="+" id="btn-add-activity" name="btn-add-activity" class="input inline small">
              ...
              <div class="emp-job-activity-details <?php echo $jobs[0]['job_activity']; ?><?php //if($jobs[0]['job_activity'] == "one") { echo "one"; } else { echo "multiple"; } ?>">
                <?php 
                $i = 1; 
                ...
                <div class="activityReunion" id="activityReunion1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td>
  						<label class="radio-custom">
                          <input type="radio" name="jp_start_stop_time<?php echo $i; ?>[]" value="fixed" id="jp_start_stop_time_fix" <?php if($job_activi['activity_type'] == "fixed") { echo "checked"; } ?>>
                          <span class="radio"></span>fixed start and stop time <a href="javascript:void(0);" class="calendar-icon">date</a></label>
  						
  						<span class="sep">or</span>
  						
  						<label class="radio-custom">
                          <input type="radio" name="jp_start_stop_time<?php echo $i; ?>[]" value="flexible" id="jp_start_stop_time_flex"  <?php if($job_activi['activity_type'] == "flexible") { echo "checked"; } ?>>
                    ...
                    <tr>
                      ...
                      <td><div class="row">
                          <div class="col-md-6">
                            <div class="row">
  							<div class="col-md-6">
                                <input type="hidden" class="cityNameId" value="<?php echo $job_activi['city']; ?>">
                                 <select onchange="onchangeState(this);" data-attribute='activityReunion1' name="jp_act_state[]" id="sel12 stateId" class="jp_act_state input small states">
                                   <option value="">Select State</option>
                                   <?php 
                                   foreach($states as $state) {
                                    ?>
                                    <option value="<?php echo $state['id']; ?>" <?php if($job_activi['state'] == $state['id']) { echo "selected"; } ?>><?php echo $state['name']; ?></option>
                                    <?php
                                   }
                                    ?>
                                </select>
                          ...
                          <div class="col-md-6">
                            <div class="row">
                              <div class="col-md-6">
  				                      <input value="<?php echo $job_activi['street']; ?>"  type="text" class="input small" name="jp_act_street[]" id="jp_act_street" placeholder="street" >
                                <!--<select name="" class="input small">
                                  <option>street</option>
                                </select>-->
                              </div>
                              <div class="col-md-6">
                                <input value="<?php echo $job_activi['zip']; ?>"  type="text" class="input small" name="jp_act_zip[]" id="jp_act_zip"  placeholder="zip" onkeyup="isValidPostalCode(this)">
                    ...
                    <tr>
                      ...
                      <td><div class="row">
                          <div class="col-md-6">
                            <input value="<?php echo $job_activi['first_name']; ?>"  name="jp_act_cont_fname[]" id="jp_act_cont_fname" type="text" placeholder="first name" class="input small">
                          </div>
                          <div class="col-md-6">
                            <input value="<?php echo $job_activi['last_name']; ?>"  name="jp_act_cont_lname[]" id="jp_act_cont_lname" type="text" placeholder="last name" class="input small">
                          </div>
                        </div></td>
                    </tr>
                    <tr>
                      ...
                      <td><div class="row">
                          <div class="col-md-6">
                            <input value="<?php echo $job_activi['phone']; ?>"  name="jp_act_cont_phne[]" id="jp_act_cont_phne" type="text" placeholder="phone" class="input small">
                          </div>
                          <div class="col-md-6">
                            <input value="<?php echo $job_activi['email']; ?>"  name="jp_act_cont_email[]" id="jp_act_cont_email" type="text" placeholder="email" class="input small">
                          </div>
                        </div></td>
                    </tr>
                    <tr>
                      <th scope="row">Notes/tasks:</th>
                      <td><textarea name="jp_act_notes[]" id="jp_act_notes" cols="" rows="" class="input small" placeholder="text here"><?php echo $job_activi['notes']; ?></textarea></td>
                    </tr>
                  </table>
                </div>
                  <?php
                 ...
                 ?>
                <div class="multiple-selected-option" <?php if($jobs[0]['job_activity'] == "one") { echo "style='display:none;'"; } else { echo "style='display:block;'"; } ?>>
                  <h3>Activites completed by contractor</h3>
                  <label for="actCondition1" class="radio-custom">
                    <input id="actCondition1" name="jp_actvty_comp" type="radio" value="yes" <?php if($jobs[0]['job_contractior_activity'] == "yes" || $jobs[0]['job_contractior_activity'] == "") {echo "checked"; } ?>>
                  ...
                  <label for="actCondition2" class="radio-custom">
                    <input id="actCondition2" name="jp_actvty_comp" type="radio" value="no" <?php if($jobs[0]['job_contractior_activity'] == "no") {echo "checked"; } ?>>
                    <span class="radio"></span> No, the contractor can select a minimum of
                    <input type="number" name="jp_num_of_actvty" id="jp_num_of_actvty" value="<?php echo $jobs[0]['job_minimum_contractor']; ?>" class="input inline x-small" <?php if($jobs[0]['job_contractior_activity'] != "no") {echo "disabled"; } ?>>
            ...
            <div class="emp-distance-area">
              ...
              <div class="distance-table">
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_location'] == "5") {echo "checked";} ?>  type="radio" name="jp_empDistance" value="5" id="jp_empDistance_5" checked>
		...
		c0.532,0.534,1.227,0.801,1.934,0.801c0.694,0,1.401-0.267,1.937-0.801c1.066-1.069,1.066-2.801,0-3.87L59.414,55.211z
		 M59.414,55.211"/>
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_location'] == "30") {echo "checked";} ?>  type="radio" name="jp_empDistance" value="30" id="jp_empDistance_30">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 18 200 164" xml:space="preserve">
                  <g>
                    <path d="M100,18c-45.216,0-82,36.784-82,82c0,45.218,36.784,82,82,82c45.218,0,82-36.782,82-82C182,54.784,145.218,18,100,18
		L100,18z M100,176.528c-42.203,0-76.526-34.327-76.526-76.528c0-42.203,34.324-76.526,76.526-76.526
		...
		c0.532,0.534,1.227,0.801,1.934,0.801c0.694,0,1.401-0.267,1.937-0.801c1.066-1.069,1.066-2.801,0-3.87L59.414,55.211z
		 M59.414,55.211"/>
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_location'] == "60") {echo "checked";} ?>   type="radio" name="jp_empDistance" value="60" id="jp_empDistance_60">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 18 200 164" xml:space="preserve">
                  <g>
                    <path d="M100,18c-45.216,0-82,36.784-82,82c0,45.218,36.784,82,82,82c45.218,0,82-36.782,82-82C182,54.784,145.218,18,100,18
		L100,18z M100,176.528c-42.203,0-76.526-34.327-76.526-76.528c0-42.203,34.324-76.526,76.526-76.526
		...
		c0.532,0.534,1.227,0.801,1.934,0.801c0.694,0,1.401-0.267,1.937-0.801c1.066-1.069,1.066-2.801,0-3.87L59.414,55.211z
		 M59.414,55.211"/>
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_location'] == "120") {echo "checked";} ?>  type="radio" name="jp_empDistance" value="120" id="jp_empDistance_120">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 18 200 164" xml:space="preserve">
                  <g>
                    <path d="M100,18c-45.216,0-82,36.784-82,82c0,45.218,36.784,82,82,82c45.218,0,82-36.782,82-82C182,54.784,145.218,18,100,18
		L100,18z M100,176.528c-42.203,0-76.526-34.327-76.526-76.528c0-42.203,34.324-76.526,76.526-76.526
		...
		c0.532,0.534,1.227,0.801,1.934,0.801c0.694,0,1.401-0.267,1.937-0.801c1.066-1.069,1.066-2.801,0-3.87L59.414,55.211z
		 M59.414,55.211"/>
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_location'] == "250") {echo "checked";} ?> type="radio" name="jp_empDistance" value="250" id="jp_empDistance_250">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 18 200 164" xml:space="preserve">
                  <g>
                    <path d="M100,18c-45.216,0-82,36.784-82,82c0,45.218,36.784,82,82,82c45.218,0,82-36.782,82-82C182,54.784,145.218,18,100,18
		L100,18z M100,176.528c-42.203,0-76.526-34.327-76.526-76.528c0-42.203,34.324-76.526,76.526-76.526
		...
		c0.532,0.534,1.227,0.801,1.934,0.801c0.694,0,1.401-0.267,1.937-0.801c1.066-1.069,1.066-2.801,0-3.87L59.414,55.211z
		 M59.414,55.211"/>
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_location'] == "nopreference") {echo "checked";} ?>  type="radio" name="jp_empDistance" value="nopreference" id="jp_empDistance_nopref">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 18 200 164" xml:space="preserve">
                  <g>
                    <path d="M100,18c-45.216,0-82,36.784-82,82c0,45.218,36.784,82,82,82c45.218,0,82-36.782,82-82C182,54.784,145.218,18,100,18
		L100,18z M100,176.528c-42.203,0-76.526-34.327-76.526-76.528c0-42.203,34.324-76.526,76.526-76.526
		 ...
		 M59.414,55.211"/>
            ...
            <div class="emp-pay-rate">
              ...
              <div class="pay-toggle">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="jp_payRate_hourly" class="radio-custom <?php if($jobs[0]['job_type'] == "hourly") {echo "active";} ?>">
                      <input  <?php if($jobs[0]['job_type'] == "hourly") {echo "checked";} ?>   type="radio" name="jp_payRate" value="hourly" id="jp_payRate_hourly" checked>
		...
		c-0.009-4.146-3.427-7.596-7.562-7.632c-4.236-0.036-7.725,3.385-7.747,7.598C92.36,104.164,95.808,107.646,100.017,107.653z"/>
                    ...
                    <div class="pay-figure">
                      <input <?php if($jobs[0]['job_type'] == "hourly") {?> value="<?php echo $jobs[0]['job_price']; ?>" <?php } ?> name="jp_payRate_hourly_val" id="jp_payRate_hourly_val" type="text" Placeholder="$40/hr">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <label for="jp_payRate_fixed" class="radio-custom <?php if($jobs[0]['job_type'] == "fixed") {echo "active";} ?>">
                      <input <?php if($jobs[0]['job_type'] == "fixed") {echo "checked";} ?>  type="radio" name="jp_payRate" value="fixed" id="jp_payRate_fixed">
		...
		l-64.765,64.72L288.723,373.969z"/>
                    ...
                    <div class="pay-figure">
                      <input <?php if($jobs[0]['job_type'] == "fixed") {?> value="<?php echo $jobs[0]['job_price']; ?>" <?php } ?> name="jp_payRate_fixed_val" id="jp_payRate_fixed_val" type="text" Placeholder="$200">
                    </div>
                  </div>
                </div>
              </div>
              <div class="emp-flex-rates">
                ...
                <ul>
                  <li>
                    <label class="radio-custom">
                      <input <?php if($jobs[0]['job_flex_time'] == "1") {echo "checked";} ?> type="radio" name="jp_flex_freq" value="1" id="jp_flex_freq_1" checked>
                      <span class="radio"></span> Flex 1 times</label>
                  </li>
                  <li>
                    <label class="radio-custom">
                      <input <?php if($jobs[0]['job_flex_time'] == "2") {echo "checked";} ?>  type="radio" name="jp_flex_freq" value="2" id="jp_flex_freq_2">
                      <span class="radio"></span> Flex 2 times</label>
                  </li>
                  <li>
                    <label class="radio-custom">
                      <input <?php if($jobs[0]['job_flex_time'] == "3") {echo "checked";} ?> type="radio" name="jp_flex_freq" value="3" id="jp_flex_freq_3">
                ...
                <div class="emp-flex-rate-details clearfix">
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <?php 
                      foreach($jobs_flex as $job_acti)
                      { 
                        ?>
                        <div class="emp-flex-interval emp-flex-date-interval" name="jp_flex_interval" id="jp_flex_interval">
                        <input type="text" name="flex-month-date[]" class="input calendar-icon flex-date-picker" value="<?php echo $job_acti['flex_date']; ?>">
                        </div>
                        <?php
                      }
                       ?>
                    ...
                    <div class="col-sm-6">
                      ...
                      <?php 
                        foreach($jobs_flex as $job_acti)
                        {
                          ...
                          <input type="text" name="flex-month-completion[]" class="input percent-icon" value="<?php echo $job_acti['flex_date'] ; ?>">
                          </div>
                          <?php
                        }
                       ?>
                  ...
                  <table>
                    <tr>
                      ...
                      <td><label for="jp_pay_additonal_hours_yes" class="radio-custom">
                          <input <?php if($jobs[0]['job_additional_hours'] == "yes") {echo "checked";} ?>  id="jp_pay_additonal_hours_yes" name="jp_pay_additonal_hours" value="yes" type="radio" checked>
                          <span class="radio"></span> Yes</label>
                        <label for="jp_pay_additonal_hours_no" class="radio-custom">
                          <input <?php if($jobs[0]['job_additional_hours'] == "no") {echo "checked";} ?>  id="jp_pay_additonal_hours_no" name="jp_pay_additonal_hours" value="no" type="radio">
            ...
            <p>Set allowable time before activity</p>
                      ...
                      <td><select name="jp_allw_time_bfr_acti" id="jp_allw_time_bfr_acti" class="input inline small" value="<?php echo $job_additional_hours[0]['before_time']; ?>">
                          <option <?php if($job_additional_hours[0]['before_time'] == "15 min") {echo "selected='selected'";} ?>   value="15 min">15 min</option>
                          <option <?php if($job_additional_hours[0]['before_time'] == "30 min") {echo "selected='selected'";} ?>  value="30 min">30 min</option>
                          <option <?php if($job_additional_hours[0]['before_time'] == "60 min") {echo "selected='selected'";} ?>  value="60 min">60 min</option>
                        </select>
                        
                        <select name="jp_allw_time_aftr_acti" id="jp_allw_time_aftr_acti" class="input inline small" value="<?php echo $job_additional_hours[0]['after_time']; ?>">
                        ...
                        <input type="text" placeholder="Allowable Overages" class="input small" name="allowwable_overages" value="<?php echo $job_additional_hours[0]['price']; ?>">
                      </td>
                    </tr>
                  </table>
                </li>
                  ...
                  <table>
                    <tr>
                      ...
                      <td><label   for="jp_travelCost_Yes" class="radio-custom">
                          <input <?php if($jobs[0]['job_travel_cost'] == "yes") {echo "checked";} ?>  id="jp_travelCost_Yes" name="jp_travelCost" value="yes" type="radio">
                          <span class="radio"></span> Yes</label>
                        <label for="jp_travelCost_No" class="radio-custom">
                          <input <?php if($jobs[0]['job_travel_cost'] == "no") {echo "checked";} ?>  id="jp_travelCost_No" name="jp_travelCost" value="no" type="radio">
                          <span class="radio"></span> No</label></td>
                    </tr>
                  </table>
                </li>
            ...
            <div class="emp-preferences">
              ...
              <div class="employee-type">
                ...
                <div class="emp-pref-table"><label class="radio-custom">
                  <input <?php if($jobs[0]['job_employee_type'] == "no_preference") {echo "checked";} ?> type="radio" name="jp_preferences" value="no_preference" id="jp_preferences_no" checked="">
		...
		C173.791,33.657,173.791,31.813,172.654,30.675L172.654,30.675z M172.654,30.675"/>
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_employee_type'] == "agency") {echo "checked";} ?> type="radio" name="jp_preferences" value="agency" id="jp_preferences_agency">
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_employee_type'] == "independent") {echo "checked";} ?> type="radio" name="jp_preferences" value="independent" id="jp_preferences_independent">
  ...
  <path d="M129.464,115.834l-0.445-0.201c-1.063-0.483-2.135-0.94-3.226-1.367c-1.192-0.479-2.4-0.919-3.628-1.332
		...
		c-14.11-5.967-23.231-19.733-23.231-35.055C61.314,58.12,61.36,57.535,61.403,56.952L61.403,56.952z M61.403,56.952"/>
              ...
              <div class="hours-billed">
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_completed_on_site'] == "no_preference") {echo "checked";} ?> type="radio" name="jp_jobs_completed" value="no_preference" id="jp_jobs_completed_nopref">
                  <span class="radio"></span> no preference</label>
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_completed_on_site'] == "1-50") {echo "checked";} ?> type="radio" name="jp_jobs_completed" value="1-50" id="jp_jobs_completed_1-50">
                  <span class="radio"></span>1-50</label>
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_completed_on_site'] == "50-100") {echo "checked";} ?> type="radio" name="jp_jobs_completed" value="50-100" id="jp_jobs_completed_50-100">
                  <span class="radio"></span>50-100</label>
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_completed_on_site'] == "100-500") {echo "checked";} ?> type="radio" name="jp_jobs_completed" value="100-500" id="jp_jobs_completed_100-500">
                  <span class="radio"></span>100-500</label>
                <label class="radio-custom">
                  <input<?php if($jobs[0]['job_completed_on_site'] == "above_500") {echo "checked";} ?> type="radio" name="jp_jobs_completed" value="above_500" id="jp_jobs_completed_above500">
                  <span class="radio"></span> Above 500</label>
              </div>
              <div class="row language-industry">
                <div class="col-md-6">
                  <h4>Language</h4>
                  <input type="text" value="<?php echo $jobs[0]['job_language'] ?>"  name="jp_language" id="jp_language" class="input" Placeholder="Select language">
                ...
                <div class="col-md-6">
                  ...
                  <input value="<?php echo $jobs[0]['job_industry_knowledge']; ?>" name="industry_knowledge" placeholder="Industry Knowledge" id="industry_knowledge" type="text" class="input" value="<?php echo json_decode($jobs[0]['job_industry_knowledge']); ?>">
                </div>
              </div>
              <div class="ask-questions">
                ...
                <?php 
                  $i=0;
                  foreach($job_questions as $job_questio) {
                    if ($i==0) {
                      ?>
                      <div class="new-ques-added">
                        <textarea name="quiestions[]" cols="" rows="" class="input" placeholder="type question"><?php echo $job_questio['job_questions']; ?></textarea></div>
                      <?php
                    } else {
                      ?>
                      <div class="new-ques-added">
                        <a href="javascript:void(0)" onclick="getRemove(this)" class="remove-ques-btn">
                          <span class="sr-only">
                            Remove this question
                          </span>
                          <i class="fa fa-times" aria-hidden="true"></i>
                        </a> 
                        <textarea name="quiestions[]" cols="" rows="" class="input" placeholder="type question"><?php echo $job_questio['job_questions']; ?></textarea>
                      </div>
                      <?php
                    }
                    $i++;
              ...
              <!-- <div class="type-of-employees">
                ...
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_visibility'] == "anyone") { echo "checked"; } ?> type="radio" name="jp_emp_type" value="anyone" id="jp_emp_type_anyone">
                  <span class="radio"></span> anyone</label>
                <label class="radio-custom">
                  <input <?php if($jobs[0]['job_visibility'] == "invite_only") { echo "checked"; } ?> type="radio" name="jp_emp_type" value="invite_only" id="jp_emp_type_anyone_invite">
            ...
            <div class="job-post-btns">
              ...
              <button type="submit" name="editPost" class="btn btn-gray">Update job</button>
            </div>
          </form>
        </section>
      </div>
