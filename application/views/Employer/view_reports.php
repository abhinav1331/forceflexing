	...
	window.onload = function() {
		var chart = new CanvasJS.Chart("chartContainer", {
			...
			data: [{
				...
				dataPoints: [
				<?php 
				foreach ($myarrayCollects as $key => $value) {
					$dateCheck = explode("-" , $value['created_MonthCheck']);
					?>
		...
		var chartPrice = new CanvasJS.Chart("chartContainerPrice", {
			...
			data: [{
				...
				foreach ($priceActivity as $key => $value2) {
					$dateCheck = explode("-" , $value2['created_MonthCheck']);
					?>
		...
		var chart1 = new CanvasJS.Chart("chartContainer1", {
			...
			data: [{
				...
				dataPoints: [
				<?php 
				foreach ($myarrayCollectsCheck as $key => $value1) {
  ...
  <section class="contracts-wrap">
    <div class="container">
      <div class="contracts-main reports-expenses-main">
        <h3>Reports</h3>
        <div class="contracts-tabs employer-repo"> 
          <!-- Nav tabs -->
              ...
              <div class="summary-chart-cover">
                <ul>
                  <li>
                    ...
                    <p>Total Earned: $<?php echo $countJob ?></p>
                  </li>
                  <li> <div id="chartContainer" style="height: 252px; width: 100%;"></div> </li>
                  <li> <div id="chartContainer1" style="height: 252px; width: 100%;"></div> </li>
                  <li> <div id="chartContainerPrice" style="height: 252px; width: 100%;"></div> </li>
                </ul>
						...
						if(!empty($transactions))
						{
							foreach($transactions as $trans)
							{
								...
								<tr>
									...
									<td scope="col"><?php echo $trans['contractor']; ?></td>
						...
						if(!empty($expenses))
						{
							foreach($expenses as $expense)
							{
								...
								<tr>
									...
									<td scope="col"><?php echo $expense['contractor']; ?></td>
