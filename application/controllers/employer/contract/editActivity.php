...
$FlexPrice[0]['activity_type'];
 ?>
                <input type="hidden" class="job_id" name="job_id" value="<?php echo $job_id ?>">
                <input type="hidden" class="activity_id" name="activity_id" value="<?php echo $ActivityId ?>">
              ...
              <div class="row">
                <div class="col-md-7">
                  <input name="jp_activity_name" id="jp_activity_name" type="text" class="input small half-width"  value="<?php echo $FlexPrice[0]['activity_name']; ?>">
                </div>
              </div>
            </td>
                    </tr>
